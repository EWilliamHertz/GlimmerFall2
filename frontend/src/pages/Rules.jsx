...
const TYPES = [
  { name: "Entity", desc: "Creatures placed on the battlefield. An entity can attack the opponent's Nexus or entities at the time of casting a Rite, on the owner's own turn." },
  { name: "Rite (Spell)", desc: "Slow spells. Can be cast anytime during your turn." },
  { name: "Flash (Spell)", desc: "Fast spells. Can be cast during either player's turn to interrupt or respond." },
