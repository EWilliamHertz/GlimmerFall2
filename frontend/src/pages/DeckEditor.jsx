...
export default function DeckEditor({ initialDeck, onExit }) {
  ...
  return (
    <div data-testid="deckbuilder-page" className="max-w-7xl mx-auto px-5 py-10">
      <div className="flex items-center gap-4 mb-2">
        {onExit && (
          <button onClick={onExit} className="p-2 rounded-xl bg-white/5 hover:bg-white/10 transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white/70"><path d="M19 12H5"></path><path d="M12 19l-7-7 7-7"></path></svg>
          </button>
        )}
        <h1 className="font-display text-4xl md:text-5xl font-bold">Deck Editor</h1>
      </div>
